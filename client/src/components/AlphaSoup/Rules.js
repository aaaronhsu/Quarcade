  ...
  render() {
    return (
      <div class="rules">
        ...
        <ul>
          <li class="rules-rule">The object of the game is to <span class="rules-bold">score the most points by <span class="yellow">forming words</span></span> from the letters above</li>
          <li class="rules-rule">Valid words are subject to being <span class="rules-steal">stolen</span>. You may steal words by clicking a player's word and forming a new, longer word that contains all the letters in the stolen word. You may steal multiple words at a time.</li>
